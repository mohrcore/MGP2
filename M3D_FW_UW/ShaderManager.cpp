...
m3dfw::GLSLProgramError PTR_EXPORT(*) m3dfw__new__GLSLProgramError__arg_GLSLProgramErrorEnum_CStr(m3dfw::GLSLProgramErrorEnum * t, const char * d)
{
	return new m3dfw::GLSLProgramError(*t, d);
}

void m3dfw__delete__GLSLProgramError(m3dfw::GLSLProgramError * ptr)
{
	delete ptr;
}
...
m3dfw::ShCK EXPORT m3dfw__GLSLProgram_getShaderCompatibilityKey(m3dfw::GLSLProgram * ptr)
{
...
const m3dfw::GLSLProgramError PTR_EXPORT(*) m3dfw__GLSLProgram_getError(m3dfw::GLSLProgram * ptr)
{
	return &ptr->getError();
}

const m3dfw::GLSLProgramParseInfo PTR_EXPORT(*) m3dfw__GLSLProgram_getInfo(m3dfw::GLSLProgram * ptr)
{
	return &ptr->getInfo();
}
...
void EXPORT m3dfw__ShaderManager_clear(m3dfw::ShaderManager * ptr)
{
	ptr->clear();
}

void EXPORT m3dfw__ShaderManager_unbindProgram(m3dfw::ShaderManager * ptr)
{
	ptr->unbindProgram();
}

m3dfw::ShID EXPORT m3dfw__ShaderManager_loadProgram(m3dfw::ShaderManager * ptr, const char * v_src, const char * f_src, const char * name)
{
	return ptr->loadProgram(v_src, f_src, name);
}

void EXPORT m3dfw__ShaderManager_deleteProgram(m3dfw::ShaderManager * ptr, m3dfw::ShID id)
{
...
m3dfw::ShID EXPORT m3dfw__ShaderManager_getID(m3dfw::ShaderManager * ptr, const char * name)
{
	return ptr->getID(name);
}

bool EXPORT m3dfw__ShaderManager_isShaderAvaible(m3dfw::ShaderManager * ptr, const char * name)
{
