...
m3dfw::Vec3f PTR_EXPORT(*) m3fdw__new__Vec3f()
{
...
m3dfw::Vec2f PTR_EXPORT(*) m3fdw__new__Vec2f()
{
...
m3dfw::Vec2f EXPORT m3dfw__Vec2f_Add(m3dfw::Vec2f * ptr, m3dfw::Vec2f * right)
{
	return ptr->operator+=(*right);
}

m3dfw::Vec2f EXPORT m3dfw__Vec2f_Sub(m3dfw::Vec2f * ptr, m3dfw::Vec2f * right)
{
	return ptr->operator-=(*right);
}


m3dfw::Vec2f EXPORT m3dfw__Vec2f_Scl(m3dfw::Vec2f * ptr, float scale)
{
	return ptr->operator*=(scale);
}

m3dfw::Vec2f EXPORT m3dfw__Vec2f_Div(m3dfw::Vec2f * ptr, float div)
{
	return ptr->operator/=(div);
}
...
m3dfw::Quaternion PTR_EXPORT(*) m3fdw__new__Quaternion()
{
	return new m3dfw::Quaternion();
}

m3dfw::Quaternion PTR_EXPORT(*) m3fdw__new__Quaternion__arg_float_float_float_float(float ve, float vi, float vj, float vk)
{
